...
class ComicController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $newComic->title = $data['id'];
        $newComic->title = $data['title'];
        $newComic->description = $data['description'];
        $newComic->thumb = $data['thumb'];
        $newComic->price = $data['price'];
        $newComic->price = $data['series'];
        $newComic->price = $data['sale_date'];
        $newComic->price = $data['type'];
        $newComic->save();
    ...
    public function destroy(Comic $comic)
    {
        ...
        return redirect()->route('comics.index')->with('message', "$comic->title has been successfully deleted")->with('type', 'success');
    }
}
